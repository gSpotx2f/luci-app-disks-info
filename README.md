...
**OpenWrt >= 21.02:**
    ...
    opkg update
    wget --no-check-certificate -O /tmp/luci-app-disks-info_0.4-1_all.ipk https://github.com/gSpotx2f/packages-openwrt/raw/master/current/luci-app-disks-info_0.4-1_all.ipk
    opkg install /tmp/luci-app-disks-info_0.4-1_all.ipk
    rm /tmp/luci-app-disks-info_0.4-1_all.ipk
    /etc/init.d/rpcd restart

i18n-ru:

    wget --no-check-certificate -O /tmp/luci-i18n-disks-info-ru_0.4-1_all.ipk https://github.com/gSpotx2f/packages-openwrt/raw/master/current/luci-i18n-disks-info-ru_0.4-1_all.ipk
    opkg install /tmp/luci-i18n-disks-info-ru_0.4-1_all.ipk
    rm /tmp/luci-i18n-disks-info-ru_0.4-1_all.ipk
